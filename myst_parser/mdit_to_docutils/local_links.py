...
from myst_parser._compat import TypedDict, findall
...
class MdDocumentLinks(Transform):
    ...
    def apply(self):
        ...
        for link_node in findall(self.document)(MystProjectLink):
            ...
            anchor_matches = filter_myst_inventory(
            ...
            reference = nodes.reference(
                refid=ref.anchor,
                internal=True,
                classes=[f"{ref.domain}-{ref.otype}"],
            )
